// ignore_for_file: unused_field, avoid_print, unused_local_variable, unused_element, unnecessary_null_comparison,
...
// we need to check the initial message that we recieve
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PushNotifications")),
      body: Center(
        child: Column(
